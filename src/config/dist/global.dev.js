...
var _default = {
  ...
  complementario: [{
    texto: 'Gutiérrez, R., Martínez, L., Gómez, M., García, G., y Caycedo, M. (2020). Cartilla comportamiento emprendedor ¡camino al logro!',
    tipo: 'Libro',
    descarga: '/downloads/Anexo_5_Cartilla_comportamiento_emprendedor_camilo_al_logro.pdf'
  }],
  creditos: {
    liderEquipo: [{
